export class Game2048 {
    ...
    toggleMode() {
        this.mode = this.mode === "normal" ? "unlimited" : "normal";
        document.getElementById("mode").innerText = `Режим: ${this.mode === "normal" ? "Обычный" : "Безлимитный"}`;
        this.initGame(); // Перезапуск игры при смене режима
    }
            }
